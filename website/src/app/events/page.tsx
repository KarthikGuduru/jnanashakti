        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="mt-10 rounded-2xl border border-warm-border bg-warm-cream/50 p-6 sm:p-10">
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-text-muted sm:text-base">
                A 3-day Satsang with <strong className="text-text-primary">Swami Chidananda</strong> centered
                on the <em>Shiva Aparadha Kshamapana Stotram</em> — a profound hymn of surrender,
              ...
              {NC_SESSIONS.map((s) => (
                ...
                >
                  <div className="flex h-16 w-16 flex-col items-center justify-center rounded-lg bg-saffron text-white">
                    <span className="text-[10px] font-bold uppercase leading-none tracking-wider">{s.month}</span>
                    <span className="mt-0.5 text-xl font-bold leading-none">{s.dayNum}</span>
                  </div>
                  <div>
                    <p className="font-heading text-base font-semibold text-text-primary">{s.day}</p>
                    <p className="mt-0.5 text-xs text-text-muted">{s.date}</p>
                    <p className="mt-2 inline-block rounded-full bg-saffron/10 px-3 py-1 text-xs font-semibold text-saffron">
                      {s.time}
                    </p>
                  </div>
                </div>
