      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-saffron-dark via-saffron to-earth py-20 sm:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4">
          ...
          <h1 className="font-heading text-4xl font-bold text-white sm:text-5xl">
            Talks by <span className="font-[family-name:var(--font-sanskrit)]">Swāmi Chidānanda</span>
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/85">
            Discourses on the{" "}
            <span className="font-[family-name:var(--font-sanskrit)]">Upanishads</span>,{" "}
            <span className="font-[family-name:var(--font-sanskrit)]">Bhagavad Gītā Shankara Bhāshya</span>,
